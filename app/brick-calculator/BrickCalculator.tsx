...
export const metadata: Metadata = {
    ...
    description:
        "Calculate the number of bricks required for your wall. Supports multiple brick standards, custom brick sizes, waste allowance, and material cost estimation.",
